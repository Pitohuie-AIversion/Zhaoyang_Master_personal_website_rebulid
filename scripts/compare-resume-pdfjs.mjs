...
const run = async () => {
  ...
  const text = await extractText(new Uint8Array(pdfBuf))
  ...
  add('论文', 'DamFormer DOI', pdfPublications.damformer, sitePublicationsZh.damformer.doi, 'src/locales/zh.json:1392')
  add('论文', 'Rs-ModCubes DOI', pdfPublications.rsModCubes, sitePublicationsZh.rsModCubes.doi, 'src/locales/zh.json:1399')
  add('论文', 'Nano Energy DOI', pdfPublications.nanoEnergy, sitePublicationsZh.whiskerSensor.doi, 'src/locales/zh.json:1413')
  add('论文', 'AMT DOI', pdfPublications.admt, sitePublicationsZh.whiskerSensorArray.doi, 'src/locales/zh.json:1406')
  ...
  const crossMismatch = []
  const scholarDoiRs = '10.1109/LRA.2025.10891552'
