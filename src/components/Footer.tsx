...
const socialLinks = [
  {
    name: 'GitHub',
    href: 'https://github.com/Pitohuie',
    icon: (
  ...
  {
    name: 'LinkedIn',
    href: 'https://www.linkedin.com/in/昭阳-牟-283497384/',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        <path d="M19.586 0H4.414C1.977 0 0 1.977 0 4.414v15.172C0 22.023 1.977 24 4.414 24h15.172C22.023 24 24 22.023 24 19.586V4.414C24 1.977 22.023 0 19.586 0zM8.063 18.411c-1.454 0-2.633-1.178-2.633-2.633 0-1.454 1.178-2.633 2.633-2.633 1.454 0 2.633 1.178 2.633 2.633 0 1.454-1.178 2.633-2.633 2.633zm7.874 0c-1.454 0-2.633-1.178-2.633-2.633 0-1.454 1.178-2.633 2.633-2.633 1.454 0 2.633 1.178 2.633 2.633 0 1.454-1.178 2.633-2.633 2.633z"/>
      </svg>
    )
  },
  {
    name: 'Google Scholar',
    href: 'https://scholar.google.com/citations?user=T3AV5RgAAAAJ',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
